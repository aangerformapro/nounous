  ...
  <div class="page container d-flex flex-nowrap flex-column flex-lg-row mx-auto">
      ...
      <div class="intro d-flex flex-column justify-content-center mt-5 mt-lg-0 p-5 col-lg-6">
        ...
        <div class="d-flex flex-column">
          <a href="mailto:dailysitter@gmail.com">
            <svg fill="currentColor" class="ng-svg-icon me-3" width="25" height="25">
              <use xlink:href="#ng-mail"></use>
            </svg>
            dailysitter@gmail.com
          </a>
         
          <a href="tel:0759468231">
          <svg fill="currentColor" class="ng-svg-icon me-3" width="25" height="25">
              <use xlink:href="#ng-phone"></use>
            </svg>
            0759468231
          </a>
        </div>
